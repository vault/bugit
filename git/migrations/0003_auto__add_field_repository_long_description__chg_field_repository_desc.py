...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.long_description'
        db.add_column('git_repository', 'long_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Repository.description'
        db.alter_column('git_repository', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Repository.long_description'
        db.delete_column('git_repository', 'long_description')


        # Changing field 'Repository.description'
        db.alter_column('git_repository', 'description', self.gf('django.db.models.fields.TextField')())
