...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.email_on_update'
        db.delete_column('common_userprofile', 'email_on_update')

        # Adding field 'UserProfile.never_email'
        db.add_column('common_userprofile', 'never_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.email_on_update'
        db.add_column('common_userprofile', 'email_on_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserProfile.never_email'
        db.delete_column('common_userprofile', 'never_email')
    ...
    models = {
        ...
        'common.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'never_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
