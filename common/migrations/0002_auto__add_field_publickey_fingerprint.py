...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicKey.fingerprint'
        db.add_column('common_publickey', 'fingerprint',
                      self.gf('django.db.models.fields.CharField')(default='empty', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicKey.fingerprint'
        db.delete_column('common_publickey', 'fingerprint')
    ...
    models = {
        ...
        'common.publickey': {
            ...
            'fingerprint': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
