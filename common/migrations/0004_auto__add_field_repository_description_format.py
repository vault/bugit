...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.description_format'
        db.add_column('common_repository', 'description_format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.description_format'
        db.delete_column('common_repository', 'description_format')
